...
ln -sf "$REPO_DIR/scripts/examples/halo-status.example.sh" "$BIN_DIR/halo-status-example"
ln -sf "$REPO_DIR/scripts/examples/halo-backup.example.sh" "$BIN_DIR/halo-backup-example"

chmod +x "$REPO_DIR/scripts/halo-doctor.sh"
chmod +x "$REPO_DIR/scripts/halo-security-scan.sh"
chmod +x "$REPO_DIR/scripts/examples/halo-status.example.sh"
chmod +x "$REPO_DIR/scripts/examples/halo-backup.example.sh"
...
echo "  halo-status-example"
echo "  halo-backup-example"
echo ""
